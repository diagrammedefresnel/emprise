<?php include('inc/header.php') ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4 ">
            <h1 class="h1 mb-5 text-gray-800 mt-4">Bienvenue Ben</h1>
          </div>
            ...
            <div class="col-xl-6 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-3 "><h2>Message</h2></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800 mb-5">Nombres de messages : 18</div>
                      <div class="mt-3 text-center">
                        <a href="" class="btn btn-primary">Ecrire un message</a>
                        <a href="" class="btn btn-success">Lister les messages</a>
                      </div>
                    </div>
                    <div class="col-auto">
